...
<body>
    ...
    <section class="contact-hero">
        <div class="container">
            <h1>Contact Us</h1>
            <p>Get in touch with our team. We're here to help with any questions or concerns you may have about HelloDoc services.</p>
        </div>
    </section>
                ...
                <div class="contact-info">
                    ...
                    <div class="contact-item">
                        ...
                        <div class="contact-details">
                            <h3>Address</h3>
                            <p>123 Healthcare Street<br>Medical District<br>Colombo, Sri Lanka</p>
                        </div>
                    </div>
                    ...
                    <div class="contact-item">
                        ...
                        <div class="contact-details">
                            <h3>Email</h3>
                            <a href="mailto:info@hellodoc.com">info@hellodoc.com</a>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var map = L.map('map').setView([6.878, 79.861], 15);

            L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
            }).addTo(map);

            L.marker([6.878, 79.861]).addTo(map)
                .bindPopup('Royal Institute Colombo<br>191, Havelock Road, Colombo 5, Sri Lanka.')
                .openPopup();
        });
    </script>
